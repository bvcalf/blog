...
import com.java1234.entity.BlogTypeVo;
...
public class IndexController {
	...
	public @ResponseBody BlogTypeVo listjson()throws Exception{
		//ModelAndView mav=new ModelAndView();
		BlogTypeVo blogTypeVo = new BlogTypeVo();
		blogTypeVo.setBlogTypeList(blogTypeService.countList());//包装类，用于返回json
		//mav.addObject("blogTypeCountList",blogTypeCountList);
		//mav.setViewName("test");
		return blogTypeVo;
	}
